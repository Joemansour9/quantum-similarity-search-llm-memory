...
For the Pearson/Spearman correlation between corpus size and the multiplier-1.2 gap (Section 7.1,
"corpus size and gap are strongly correlated"), including the 48-item point from Table 5:
`scratch_correlation_transition_sizes_results.pkl`, produced by `scratch_correlation_transition_sizes.py`
(both in this folder).
